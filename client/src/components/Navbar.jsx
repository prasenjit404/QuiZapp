        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {user ? (
              ...
              <Link
                to="/login"
                className="px-4 py-2 border border-indigo-600 text-indigo-600 rounded hover:bg-indigo-50 dark:bg-gray-800 
                dark:hover:bg-indigo-200 dark:text-indigo-500"
              >
                Login
              </Link>
            )}
        ...
        <div className="md:hidden border-t border-gray-100 dark:border-gray-800">
          <div className="px-4 py-3 space-y-1 flex flex-col">
            <button
              ...
              className="w-full text-left px-3 py-2 rounded-md dark:text-white"
            >
            ...
            {user ? (
              ...
              <Link
                ...
                className="block px-3 py-2 rounded-md text-indigo-600 border border-indigo-600 dark:text-indigo-300 dark:border-indigo-500"
              >
                Login
              </Link>
            )}
